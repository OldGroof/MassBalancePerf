...
function maths() {
  ...
  document.getElementById("zfmGraph").style.top = 30 + (0.57259 * (2550 - zfm)) + "px";
  document.getElementById("lmGraph").style.top = 30 + (0.57259 * (2550 - lm)) + "px";
  document.getElementById("tomGraph").style.top = 30 + (0.57259 * (2550 - tom)) + "px";
